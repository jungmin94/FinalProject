...
<section>
	<div id="chat-total-area">
		...
		<input type="text" id="member-mbti" value="${loginMember.member_mbti}"
			style="display: none"> <input type="text" id="member-id"
...
<script>
    ...
    socket.onmessage = function(event) {
    	...
    	if (msg.chatType=='enter-all') {//입장 시 
    		...
    		if (msgUpfile == '') {
    			...
    			let addDiv = "<div class='my-total-chat-box'><div class='my-chat-box'><div class='chat-id-mbti'>"+msg.senderId+" / "+msg.senderMbti+"</div><div>"+msg.msg+"</div></div><div class='chat-time'>"+msgHour+":"+msgMin+"</div></div>"
    			$('#chat-area').append(addDiv);
            	$('#chat-area').scrollTop($('#chat-area')[0].scrollHeight);
    		} else if (checkIfImg && msgUpfile != ''){
    			let addDiv = "<div class='my-total-chat-box'><div class='my-chat-box'><div class='chat-id-mbti'>"+msg.senderId+" / "+msg.senderMbti+"</div><div>"+msg.msg+"<a href='javascript:fileDownload();'><img src='${path}/resources/upload/chatting/"+msg.uploadFile+"' width='100px'><span id='file-name' style='display:none'>"+msg.uploadFile+"</span></a></div></div><div class='chat-time'>"+msgHour+":"+msgMin+"</div></div>"
    			$('#chat-area').append(addDiv);
            	$('#chat-area').scrollTop($('#chat-area')[0].scrollHeight);
    		} else if (msgUpfile != 'null') {
    			let addDiv = "<div class='my-total-chat-box'><div class='my-chat-box'><div class='chat-id-mbti'>"+msg.senderId+" / "+msg.senderMbti+"</div><div>"+msg.msg+"<a href='javascript:fileDownload();'><span id='file-name' style='margin-left:5px;'>"+msg.uploadFile+"</span></a></div></div><div class='chat-time'>"+msgHour+":"+msgMin+"</div></div>"
    			$('#chat-area').append(addDiv);
            	$('#chat-area').scrollTop($('#chat-area')[0].scrollHeight);
    		}
    		...
    		console.log('여기오니??????????');
    		if (msgUpfile == '') {
    			let addDiv = "<div class='dm-my-total-chat-box'><div class='my-chat-box'><div class='chat-id-mbti'>"+msg.senderId+" / "+msg.senderMbti+"<span class='dm-msg'>(귓속말)</span></div><div>"+msg.msg+"</div></div><div class='chat-time'>"+msgHour+":"+msgMin+"</div></div>"
        		$('#chat-area').append(addDiv);
            	$('#chat-area').scrollTop($('#chat-area')[0].scrollHeight);
    		} else if (checkIfImg && msgUpfile != ''){
    			let addDiv = "<div class='dm-my-total-chat-box'><div class='my-chat-box'><div class='chat-id-mbti'>"+msg.senderId+" / "+msg.senderMbti+"<span class='dm-msg'>(귓속말)</span></div><div>"+msg.msg+"<a href='javascript:fileDownload();'><img src='${path}/resources/upload/chatting/"+msg.uploadFile+"' width='100px'><span id='file-name' style='display:none'>"+msg.uploadFile+"</span></a></div></div><div class='chat-time'>"+msgHour+":"+msgMin+"</div></div>"
    			$('#chat-area').append(addDiv);
            	$('#chat-area').scrollTop($('#chat-area')[0].scrollHeight);
    		} else if (msgUpfile!="") {
    			let addDiv = "<div class='dm-my-total-chat-box'><div class='my-chat-box'><div class='chat-id-mbti'>"+msg.senderId+" / "+msg.senderMbti+"<span class='dm-msg'>(귓속말)</span></div><div>"+msg.msg+"<a href='javascript:fileDownload();'><span id='file-name' style='margin-left:5px;'>"+msg.uploadFile+"</span></a></div></div><div class='chat-time'>"+msgHour+":"+msgMin+"</div></div>"
    			$('#chat-area').append(addDiv);
            	$('#chat-area').scrollTop($('#chat-area')[0].scrollHeight);
    		}
    		...
    		if (msgUpfile == '') {
    			...
    			let addDiv = "<div class='dm-total-chat-box'><div class='chat-box'><div class='chat-id-mbti'>"+msg.senderId+" / "+msg.senderMbti+"<span class='dm-msg'>(귓속말)</span></div><div>"+msg.msg+"</div></div><div class='chat-time'>"+msgHour+":"+msgMin+"</div></div>"
        		$('#chat-area').append(addDiv);
            	$('#chat-area').scrollTop($('#chat-area')[0].scrollHeight);
    		}  else if (checkIfImg && msgUpfile != '') {
    			
    			let addDiv = "<div class='dm-total-chat-box'><div class='chat-box'><div class='chat-id-mbti'>"+msg.senderId+" / "+msg.senderMbti+"<span class='dm-msg'>(귓속말)</span></div><div>"+msg.msg+"<a href='javascript:fileDownload();'><img src='${path}/resources/upload/chatting/"+msg.uploadFile+"' width='100px'><span id='file-name' style='display:none'>"+msg.uploadFile+"</span></a></div></div><div class='chat-time'>"+msgHour+":"+msgMin+"</div></div>"
    			$('#chat-area').append(addDiv);
            	$('#chat-area').scrollTop($('#chat-area')[0].scrollHeight);
    		} else if (msgUpfile!="") {
    			let addDiv = "<div class='dm-total-chat-box'><div class='chat-box'><div class='chat-id-mbti'>"+msg.senderId+" / "+msg.senderMbti+"<span class='dm-msg'>(귓속말)</span></div><div>"+msg.msg+"<a href='javascript:fileDownload();'><span id='file-name' style='margin-left:5px;'>"+msg.uploadFile+"</span></a></div></div><div class='chat-time'>"+msgHour+":"+msgMin+"</div></div>"
    			$('#chat-area').append(addDiv);
            	$('#chat-area').scrollTop($('#chat-area')[0].scrollHeight);
    		}
    		...
    		if (msgUpfile == '') {
	    		let addDiv = "<div class='total-chat-box'><div class='chat-box'><div class='chat-id-mbti'>"+msg.senderId+" / "+msg.senderMbti+"</div><div>"+msg.msg+"</div></div><div class='chat-time'>"+msgHour+":"+msgMin+"</div></div>"
	        	$('#chat-area').append(addDiv);
	        	$('#chat-area').scrollTop($('#chat-area')[0].scrollHeight);
    		} else if (checkIfImg && msgUpfile != 'null') {
    			let addDiv = "<div class='total-chat-box'><div class='chat-box'><div class='chat-id-mbti'>"+msg.senderId+" / "+msg.senderMbti+"</div><div>"+msg.msg+"<a href='javascript:fileDownload();'><img src='${path}/resources/upload/chatting/"+msg.uploadFile+"' width='100px'><span id='file-name' style='display:none'>"+msg.uploadFile+"</span></a></div></div><div class='chat-time'>"+msgHour+":"+msgMin+"</div></div>"
    			$('#chat-area').append(addDiv);
            	$('#chat-area').scrollTop($('#chat-area')[0].scrollHeight);
    		} else if (msgUpfile!="") {
    			let addDiv = "<div class='total-chat-box'><div class='chat-box'><div class='chat-id-mbti'>"+msg.senderId+" / "+msg.senderMbti+"</div><div>"+msg.msg+"<a href='javascript:fileDownload();'><span id='file-name' style='margin-left:5px;'>"+msg.uploadFile+"</span></a></div></div><div class='chat-time'>"+msgHour+":"+msgMin+"</div></div>"
    			$('#chat-area').append(addDiv);
            	$('#chat-area').scrollTop($('#chat-area')[0].scrollHeight);
    		}
