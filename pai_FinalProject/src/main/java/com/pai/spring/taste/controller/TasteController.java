...
public class TasteController {
	...
	public ModelAndView insertTaste(Taste t, String member_id, ModelAndView mv) {
		//멤버 아이디로 먼저 데이터 조회해서 
		System.out.println(t);
		t.setMember_id(new Member());
		t.getMember_id().setMember_id(member_id);
		//Taste t = service.selectTasteOne(memberId);
		
		//있으면 기존 데이터 삭제 후 insert
		//없으면 insert
